/**
 * MentoriaMetodo6015Page.jsx
 * Rota: /mentoria_metodo6015
 *
 * SETUP NECESSÁRIO:
 * 1. Coloque sua foto em: C:\Projetos\ft-web\public\frantiesco-mentoria.jpg
 * 2. Crie conta grátis em formspree.io → New Form → copie o ID
 *    Substitua "xpqnjylg" na linha ~100 pelo seu ID
 * 3. Adicione a rota no App.jsx (ver instruções no README abaixo)
 */
...
const FAQS = [
  { q: 'Preciso saber programar ou análise técnica?',
    a: 'Não. Os robôs já estão prontos e configurados. O treinamento ensina como usá-los corretamente — não como criá-los. Se você sabe ligar o computador, já tem o suficiente.' },
  { q: 'Quanto tempo por dia preciso dedicar?',
    a: 'Na prática, de 3 a 5 minutos já são suficientes para acompanhar. Quem quer se aprofundar pode dedicar mais. Quem quer algo mais automático também consegue operar assim.' },
  ...
  { q: 'Quando abre a próxima turma?',
    a: 'As turmas abrem de vez em quando, com vagas limitadas. Não há uma data definida agora. A lista de espera é a única forma de garantir prioridade quando as vagas abrirem.' },
  { q: 'Tem garantia?',
    a: 'Sim — 7 dias de garantia integral. Se nos primeiros 7 dias você sentir que a mentoria não é para você, devolvemos 100% do valor. Isso não é garantia de retorno financeiro: mercado sempre envolve risco.' },
  { q: 'Qual a diferença para outros cursos de trading?',
    a: 'Você opera o mesmo portfólio que eu opero, com resultados mostrados em conta real mês a mês — incluindo os meses negativos. Não é teoria com resultados maquiados. É prática real com acompanhamento direto.' },
  { q: 'Depois da mentoria fico sozinho?',
    a: 'Enquanto você está na mentoria (semestral ou anual), tem acesso completo. Ao final, você sai com o conhecimento, os robôs configurados e a lógica para continuar. Renovação é opcional.' },
]
...
function AnimCount({ to, suffix = '', dur = 1600 }) {
...
export default function MentoriaMetodo6015Page() {
  ...
  // Injeta fontes sem tocar no index.html
  useEffect(() => {
    const id = 'm6015-fonts'
    if (document.getElementById(id)) return
    const l = document.createElement('link')
    l.id = id; l.rel = 'stylesheet'
    l.href = 'https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,300;0,9..144,600;0,9..144,900;1,9..144,700&family=DM+Sans:wght@300;400;500;600&display=swap'
  ...
  async function submit(e) {
    ...
    setStatus('sending')
    try {
      // ↓ Troque "xpqnjylg" pelo ID do seu form em formspree.io
    ...
    <div className="m6">
        ...
        <div className="m6-hero-inner">
          <div className="m6-hero-text">
            ...
            <p className="m6-hero-sub">
              O Método 6015 não é um curso comum — é um acompanhamento completo
              com os mesmos robôs e portfólio que eu opero, em conta real, mês a mês.
            </p>
          ...
          <div className="m6-hero-photo">
            {/* Coloque sua foto em: public/frantiesco-mentoria.jpg */}
            <img src="/frantiesco-mentoria.jpg" alt="Frantiesco Trader" />
          </div>
        </div>
      </section>
      ...
      <section className="m6-section">
        <div className="m6-wrap">
          <p className="m6-label">RESULTADOS REAIS · CONTA REAL · FEV/25 → JAN/26</p>
          <h2 className="m6-h2">12 meses. Sem edição. Sem cortes.</h2>
          <p className="m6-sub">Incluindo o mês negativo — porque é assim que o mercado funciona, e é assim que o Método 6015 se apresenta.</p>

          <div className="m6-months">
            {MONTHLY.map(({ m, v }) => (
              <div key={m} className={`m6-month ${v >= 0 ? 'pos' : 'neg'}`}>
          ...
          <div className="m6-tbl-wrap">
            <table className="m6-tbl">
              <thead>
                <tr><th>Portfólio</th><th>Semestre</th><th>Total acumulado</th></tr>
              </thead>
              <tbody>
                {PORTFOLIOS.map(p => (
                  <tr key={p.name}>
      ...
      <section className="m6-section alt">
        <div className="m6-wrap">
          <p className="m6-label">O QUE ESTÁ INCLUÍDO</p>
          <h2 className="m6-h2">Cinco pilares. Um método.</h2>
          <div className="m6-pillars">
            {PILLARS.map(p => (
              <div key={p.n} className="m6-pillar">
      ...
      <section className="m6-section">
        <div className="m6-wrap m6-forwho">
          <div className="m6-forwho-text">
            <p className="m6-label">PARA QUEM É</p>
            <h2 className="m6-h2">Criterioso por design.</h2>
            <p className="m6-sub">Prefiro perder uma venda do que colocar alguém despreparado dentro da mentoria.</p>
          ...
          <div className="m6-nums">
            {[
              ...
              <div key={lbl} className="m6-num-card">
      ...
      <section className="m6-section alt" id="preco">
        <div className="m6-wrap">
          <p className="m6-label">INVESTIMENTO</p>
          <h2 className="m6-h2">Sem letras miúdas.</h2>
          <div className="m6-plans">
            ...
            <div className="m6-plan">
              ...
              <h4>Semestral</h4>
              <div className="m6-price">
                <strong>R$ 1.997</strong>
                <span>ou 12× de R$ 205,32</span>
              </div>
              <ul>
            ...
            <div className="m6-plan featured">
              ...
              <h4>Anual</h4>
              <div className="m6-price">
                <strong>R$ 2.997</strong>
                <span>ou 12× de R$ 308,00</span>
              </div>
              <ul>
      ...
      <section className="m6-section alt">
        <div className="m6-wrap m6-faq-wrap">
          <p className="m6-label">PERGUNTAS FREQUENTES</p>
          <h2 className="m6-h2">Respostas diretas.</h2>
      ...
      <section className="m6-section" id="lista">
        <div className="m6-wrap m6-form-wrap">
          <p className="m6-label">LISTA DE ESPERA</p>
          <h2 className="m6-h2">Avise-me quando abrir.</h2>
          <p className="m6-sub">Quando a próxima turma abrir, os inscritos têm prioridade — e às vezes acesso a condições especiais antes do anúncio público.</p>
          ...
          {status === 'ok' ? (
            ...
            <form className="m6-form" onSubmit={submit}>
              <input
                className="m6-input" type="text" placeholder="Seu nome" required
                value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))}
              />
              <input
                className="m6-input" type="email" placeholder="Seu melhor e-mail" required
              ...
              {status === 'err' && (
                <p className="m6-err">Erro ao enviar. Tente novamente ou me chame no WhatsApp.</p>
              )}
      ...
      <footer className="m6-footer">
        ...
        <p className="m6-footer-disc">
          ...
          envolvem riscos, incluindo a possibilidade de perda do capital investido.
